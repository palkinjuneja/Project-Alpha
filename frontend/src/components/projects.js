...
function Projects(props) {
              ...
              <div className="col-sm-10" key={project._id}>
                      <div className="card" style={{borderColor: "#00AA9E"}}>
                        <div className="card-body" style={{paddingTop: "2%", paddingBottom: "2%"}}>
                          ...
                          <button className="btn btn-primary" style = {{float: 'left',marginLeft:'5px',textAlign:'center'}} onClick={event=>window.location.href="/projectDetails/"+project._id}>More</button>
                          {(project.owner_id==data.userId)?
                        <button type="button" class="btn btn-primary" style = {{float: 'left',marginLeft:'5px'}} onClick={event =>  window.location.href='/editProject/'+project._id}>Edit</button>:null}
                        </div>
                      </div>
                      <br/><br/>
                  </div>
    ...
    return (
        <div>
         <NavHeader middleText={<FindPeople/>}/>
